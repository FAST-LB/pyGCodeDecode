...
![Trapezoidal Velocity Profile.\label{fig:trapezoid}](trapezoid_profile.png){width=20%}
Equations for the individual distances for linear acceleration, constant velocity and decelleration.
$$
